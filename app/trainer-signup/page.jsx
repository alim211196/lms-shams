    ...
    <div className="auth-main">
      ...
      <div className="auth-wrap">
        <div className="auth-bg">
           <Image src={authSignUp} alt='login' />
        </div>
        <div className="auth-right">
          <div className="log_wraps">

            <div className="log__heads">
              <h4 className="logs_title">Become a Shams Training instructor</h4>
            ...
            <div className="form-group">
            <Link href="#" className="btn_apply">Sign up</Link>
            </div>

            <div className="allready-login form-group text-center">
              <span>Already Have A Account? <Link href='#'> Log in</Link></span>
            </div>
