              ...
              <div className="heroRight">
                ...
                <div className="heroRightBottom">
                  <div class="course-price">
                    ...
                    <span class="off-price"><span>AED 50</span> 10%off </span>
                  </div>
                  <div className="enrollBtn">
                    <a class="pirmaryBtn" href="">Enroll Now</a>
                  </div>
       ...
       <section className="courseSection">
        <div className="container">
          ...
          <div className="sectionTitle left">
            <h2 className="title">A broad selection of courses.
              Our powerful Masterclasses to unlock your Potential!</h2>
          </div>

          <div className="row">
            <div className="col-lg-12">
              <ul className="filter-tab text-center">
                <li className="nav-item"> <Link href="#">All</Link> </li>
        ...
        <div className="factArtWrap">
          <div className="factLeft">
            <div className="sectionTitle">
              ...
              <Link href="#" className="pirmaryBtn book-now">Book Now</Link>
            </div>
            </div>
